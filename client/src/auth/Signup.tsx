  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <form onSubmit={loginSubmitHandler} className="md:p-8 w-full max-w-md rounded-lg md:border border-gray-200 mx-4">
        <div className="mb-4">
          <h1 className="font-bold text-2xl">BindalEats</h1>
        </div>
        <div className="mb-4">
        ...
        <div className="mb-10">
          {loading ? (
            <Button disabled className="w-full bg-[var(--button)] hover:bg-[var(--hoverButtonColor)]">
              <Loader2 className="mr-2 h-4 w-4 animate-spin" /> Please wait
            </Button>
          ) : (
            <Button type="submit" className="w-full bg-[var(--button)] hover:bg-[var(--hoverButtonColor)] ">
              Signup
            </Button>
          )}
        </div>
