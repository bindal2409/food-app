        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="bg-[var(--button)] hover:bg-[var(--hoverButtonColor)]"
            >
              Search
            </Button>
          </div>
                  ...
                  >
                    ...
                    <CardFooter className="p-4 border-t dark:border-t-gray-700 border-t-gray-100 text-white flex justify-end">
                      <Link to={`/restaurant/${restaurant._id}`}>
                        <Button className="bg-[var(--button)] hover:bg-[var(--hoverButtonColor)] font-semibold py-2 px-4 rounded-full shadow-md transition-colors duration-200">
                          View Menus
                        </Button>
                      </Link>
                    </CardFooter>
...
const NoResultFound = ({ searchText }: { searchText: string }) => {
  return (
    <div className="text-center">
      ...
      <Link to="/">
        <Button className="mt-4 bg-[var(--button)] hover:bg-[var(--hoverButtonColor)]">
          Go Back to Home
        </Button>
      </Link>
    </div>
